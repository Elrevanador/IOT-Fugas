...
const bool DEMO_PRESION_VIRTUAL_DESDE_FLUJO = DEMO_SENSIBLE;
const float DEMO_PRESION_VIRTUAL_MAX_KPA = 14.0f;
const float DEMO_PRESION_VIRTUAL_MIN_KPA = 2.0f;
const float DEMO_FLUJO_NORMAL_LMIN = 1.80f;
const float DEMO_FLUJO_FUGA_LMIN = 3.50f;
